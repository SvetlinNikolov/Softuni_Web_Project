...
namespace SPN.Forum.Data.Migrations
{
    ...
    [Migration("20200315112244_Removed_Foreign_Key_In_Contest_Question_And_In_Contest")]
    partial class Removed_Foreign_Key_In_Contest_Question_And_In_Contest
    {
            ...
            modelBuilder.Entity("SPN.Quiz.Data.Models.ContestQuestionAnswer", b =>
                {
                    ...
                    b.Property<int>("ContestQuestionContestId")
                        .HasColumnType("int");

                    b.Property<int>("ContestQuestionId")
                        .HasColumnType("int");

                    b.Property<int>("ContestQuestionId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ContestQuestionId1", "ContestQuestionContestId");
            ...
            modelBuilder.Entity("SPN.Quiz.Data.Models.ContestQuestionAnswer", b =>
                {
                    ...
                    b.HasOne("SPN.Quiz.Data.Models.ContestQuestion", "ContestQuestion")
                        .WithMany("ContestQuestionAnswers")
                        .HasForeignKey("ContestQuestionId1", "ContestQuestionContestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
