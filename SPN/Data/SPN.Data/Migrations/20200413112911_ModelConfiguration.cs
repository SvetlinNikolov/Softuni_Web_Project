        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryPropertiesId = table.Column<int>(nullable: false),
                    SafetyId = table.Column<int>(nullable: false),
                    InteriorsId = table.Column<int>(nullable: false),
                    InteriorMaterialsId = table.Column<int>(nullable: false),
                    SuspensionsId = table.Column<int>(nullable: false),
                    SpecializedFeaturesId = table.Column<int>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
